                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                            ...
                            content: AlertBox(
                                payMent: 'Draft bills',
                                buttonName: null,
                                widget: context.watch<ExpenseController>().onholdfilter.isEmpty
                                    ? ContentContainer(
                                            ...
                                            child: Column(
                                                ...
                                                children: [
                                                  Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: context.watch<ExpenseController>()
                                                          .mycontroller[2],
                                                      cursorColor: Colors.grey,
                                                      onChanged: (v) {
                                                        st((){
                                                          context.read<ExpenseController>().filterListOnHold(v);
                                                        });
                                                      },
                                                  ...
                                                  SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                          itemCount: context.watch<ExpenseController>()
                                                              .onholdfilter.length,
                                                          itemBuilder:
                                                              (context, index) {
                                                            return Card(
                                                                  ...
                                                                  title: Column(
                                                                    ...
                                                                    children: [
                                                                      Row(
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            child: Text(context.watch<ExpenseController>()
                                                                                .onholdfilter[index]
                                                                                .expensecode!),
                                                                          ),
                                                                          // Container(
