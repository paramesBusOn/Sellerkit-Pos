...
class PayBillingOptions extends StatelessWidget {
  ...
  // final PayreceiptController payController;
  @override
                                                    ...
                                                    SizedBox(
                                                        ...
                                                        child: ListView.builder(
                                                            ...
                                                            itemBuilder:
                                                                (context,
                                                                    index) {
                                                              log("onHoldFilter Customer Name::${context
                                                                      .watch<
                                                                          PayreceiptController>()
                                                                      .onHoldFilter!
                                                                      .length}");
                                                                      ...
                                                                      children: [
                                                                        Row(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Container(
                                                                              child: Text(context.watch<PayreceiptController>().onHoldFilter![index].invoceDate!),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                        Row(
