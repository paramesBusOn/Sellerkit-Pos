// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, non_constant_identifier_names, use_build_context_synchronously, unnecessary_string_interpolations, must_be_immutable
              ...
              child: Column(
                ...
                children: [
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              Container(
                                child: Form(
                                  key: context.read<StockOutwardController>().formkey[0],
                                  child: Row(
                                    children: [
                                      Container(
                                      ...
                                      Container(
                                        ...
                                        child:
                                            ...
                                            TextFormField(
                                          controller: context.read<StockOutwardController>().StOutController[100],
                                          readOnly: true,
                                          validator: (value) {
                                            if (value!.isEmpty) {
                                              return "Required";
                                          ...
                                          onTap: () {
                                            context.read<StockOutwardController>().getDate2(context, 'From');
                                          },
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child:
                                        ...
                                        readOnly: true,
                                        controller: context.read<StockOutwardController>().StOutController[101],
                                        onTap: () {
                                          context.read<StockOutwardController>().getDate2(context, 'To');
                                        },
                                        decoration: InputDecoration(
                                            contentPadding: EdgeInsets.symmetric(vertical: 5.0, horizontal: 5.0),
                                            border: OutlineInputBorder(borderRadius: BorderRadius.circular(4)),
                              ...
                              GestureDetector(
                                onTap: () {
                                  setState(() {
                                    if (context.read<StockOutwardController>().formkey[0].currentState!.validate()) {
                                      // StOut_Con.tappage.animateToPage(
                                      //     ++StOut_Con.tappageIndex,
                                      //     duration: Duration(milliseconds: 400),
                                      //     curve: Curves.linearToEaseOut);
                                      context.read<StockOutwardController>().getSalesDataDatewise(context.read<StockOutwardController>().StOutController[100].text.toString(), context.read<StockOutwardController>().StOutController[101].text.toString());
                                    }
                                  });
                                },
                                child: Container(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      onChanged: (value) {
                                        setState(() {
                                          context.read<StockOutwardController>().filterSearchBoxList(value.trim());
                                        });
                                      },
                  ...
                  Container(
                    ...
                    child: context.watch<StockOutwardController>().filtersearchData.isEmpty
                        ? Center(
                            child: Text("No Data Here..!!"),
                          )
                        : ListView.builder(
                            itemCount: context.watch<StockOutwardController>().filtersearchData.length,
                            itemBuilder: (context, index) {
                              return InkWell(
                                onTap: () async {
                                  await context.read<StockOutwardController>().fixDataMethod(context.read<StockOutwardController>().filtersearchData[index].docentry);
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.watch<StockOutwardController>().filtersearchData[index].docNo}",
                                      ...
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.read<StockOutwardController>().config.alignDate(context.read<StockOutwardController>().filtersearchData[index].docDate)}",
                                          style: widget.theme.textTheme.bodyLarge!.copyWith(color: Colors.black),
                                        ),
                                      ),
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.watch<StockOutwardController>().filtersearchData[index].username}",
                                          style: widget.theme.textTheme.bodyLarge!.copyWith(color: Colors.black),
                                        ),
                                      ),
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.watch<StockOutwardController>().filtersearchData[index].terminal}",
                                          style: widget.theme.textTheme.bodyLarge!.copyWith(color: Colors.black),
                                        ),
                                      ),
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.watch<StockOutwardController>().filtersearchData[index].sapNo}",
                                      ...
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.watch<StockOutwardController>().filtersearchData[index].qStatus}",
                                          style: widget.theme.textTheme.bodyLarge!.copyWith(color: Colors.black),
                                        ),
                                      ),
                                      Container(
                                        ...
                                        // color: Colors.amber,
                                        child: Text(
                                          "${context.watch<StockOutwardController>().filtersearchData[index].customeraName}",
                                          style: widget.theme.textTheme.bodyLarge!.copyWith(color: Colors.black),
                                        ),
                                      ),
                                      Container(
