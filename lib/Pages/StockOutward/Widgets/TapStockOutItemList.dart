...
class StockOutwardPageviewerLeft extends StatelessWidget {
        ...
        Container(
          ...
          child:
            ...
            children: [
              ...
              data!.isEmpty?const Text("No data..!!"):
              Card(
                child: InkWell(
                  onTap: () {
                    //  context.read<StockOutwardController>().valPass(
                    //     data![ context.watch<StockOutwardController>().selectIndex2!].Scanned_Qty!);
                    //  context.watch<StockOutwardController>().StOutController[0].text = "";
                    //  context.watch<StockOutwardController>().ScannigVal =
                    //     data![ context.watch<StockOutwardController>().selectIndex2!].Scanned_Qty!;
                    // // posC.Scanloop(data![i].serialbatch, i);
                    // // data![i].serialBatch!;
                    // context.read<StockOutwardController>().getBatchData(index,
                    //     context.read<StockOutwardController>().selectIndex2!);
                  },
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: data![context.watch<StockOutwardController>().selectIndex2!].Scanned_Qty != 0 &&
                                data![context.watch<StockOutwardController>().selectIndex2!].qty !=
                                    (data![context.watch<StockOutwardController>().selectIndex2!]
                                            .Scanned_Qty! +
                                        data![context.watch<StockOutwardController>().selectIndex2!]
                                            .trans_Qty!)
                            ? const Color(0xFFfcedee)
                            : data![context.watch<StockOutwardController>().selectIndex2!].Scanned_Qty != 0 &&
                                    data![context.watch<StockOutwardController>().selectIndex2!].qty ==
                                        (data![context.watch<StockOutwardController>().selectIndex2!]
                                                .Scanned_Qty! +
                                            data![context.watch<StockOutwardController>().selectIndex2!]
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: Column(
                                ...
                                children: [
                                 data==null? Text(""):Text(
                                    "${data![context.watch<StockOutwardController>().selectIndex2!].itemcode}",
                                    style: theme.textTheme.bodyLarge,
                                    // maxLines: 2,
                                  ),
                                  Container(
                                      alignment: Alignment.centerLeft,
                                      child: data==null? Text(""):Text(
                                        " ${data![context.watch<StockOutwardController>().selectIndex2!].serialBatch} ",
                                        style: theme.textTheme.bodyLarge,
                                      ))
                                ],
                              ),
                            ...
                            Container(
                              ...
                              width: stockInWidth * 0.15,
                              child:data==null? Text(""): Text(
                                "${data![context.watch<StockOutwardController>().selectIndex2!].trans_Qty}",
                                style: theme.textTheme.bodyLarge,
                              ),
                            ),
                            Container(
  ...
  //                 controller: stoutCon.StOutController[0],
  //                 onEditingComplete: () {
  //                   st(() {
  ...
  //                 stoutCon.stoutLineRefersh(index!, ind!);
